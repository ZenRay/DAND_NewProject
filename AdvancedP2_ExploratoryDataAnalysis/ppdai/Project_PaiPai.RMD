...
2. 在 Invenstment 数据中
  ...
  * 关于下次还款信息 **下次计划还款日期**, **下次计划还款本金**, **下次计划还款利息** 是缺失是一致的，说明目前还没有开始换框。数据是具有意义的
  * **上次还款本金** 和 **上次还款利息** 中缺失值因为上次没有发生还款；此外存在 **上次还款日期** 是缺失值而另两个上次还款信息不是缺失值的情况，需要依据之前的信息来判断
