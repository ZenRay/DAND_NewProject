...
# 加载数据
df.lc <- read.csv("./LC.csv")
df.lp <- read.csv("./LP.csv")
df.lcis <- read.csv("./LCIS.csv")
```
...
df.lcis$下次计划还款日期 <- as.character.Date(df.lcis$下次计划还款日期)
...
4. [W1H1_078姜冰钰 - Kesci.com](https://www.kesci.com/home/project/58c80072ed74a44eb1b8d57f)